// Copied from https://github.com/dbramwell/react-animate-on-scroll
// There was a nasty bug I was hitting, so I fixed it locally
...
export default class ScrollAnimation extends Component {
  ...
  getVisibility() {
    // Fix bug when node ref is not defined (not quite sure what is causing this)
    if (!this.node) return { inViewport: false, onScreen: false };
